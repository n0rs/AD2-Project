...
public class PasswortVerwaltung {
    ...
    public static Kunde newPassword(Kunde kunde, Scanner scanner) throws RemoteException, MalformedURLException, NotBoundException {
    ...
    public static Kunde prepareReset(Scanner scanner) throws RemoteException, MalformedURLException, NotBoundException {
        DatenbankManagerInterface db = (DatenbankManagerInterface) java.rmi.Naming.lookup("rmi://localhost:1099/DatenbankManager");
        String email;
            while (true) {
